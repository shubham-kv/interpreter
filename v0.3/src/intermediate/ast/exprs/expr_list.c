...
static const struct AstNodeType _type_list_expr = {
	.size 					= sizeof(struct ListExpr),
	.constructor 			= list_expr_constructor,
	.destructor 			= list_expr_destructor,

	.accept_visitor 		= list_expr_accept_visitor,
	.is_ast_node 			= is_list_expr,

	.get_leftmost_token 	= list_expr_get_lmost_token,
	.get_rightmost_token 	= list_expr_get_rmost_token,
	.get_tokens 			= NULL
};
