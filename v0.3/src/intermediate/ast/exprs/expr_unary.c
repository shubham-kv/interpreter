...
static const struct AstNodeType _type_unary_expr = {
	.size 					= sizeof(struct UnaryExpr),
	.constructor 			= unary_expr_constructor,
	.destructor 			= unary_expr_destructor,

	.accept_visitor 		= unary_expr_accept_visitor,
	.is_ast_node 			= is_unary_expr,

	.get_leftmost_token 	= unary_expr_get_lmost_token,
	.get_rightmost_token 	= unary_expr_get_rmost_token,
	.get_tokens 			= NULL
};

const void *UnaryExpr = &_type_unary_expr;
