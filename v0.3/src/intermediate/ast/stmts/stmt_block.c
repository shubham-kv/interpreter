...
static void *block_stmt_constructor(void *self, va_list *ap);
static void *block_stmt_destructor(void *self);

static void *block_stmt_accept_visitor(const void *self, const void *ast_visitor);
static bool is_block_stmt(const void *object);


static const struct AstNodeType _type_block_stmt = {
	.size 					= sizeof(struct BlockStmt),
	.constructor 			= block_stmt_constructor,
	.destructor 			= block_stmt_destructor,
	.accept_visitor 		= block_stmt_accept_visitor,
	.is_ast_node 			= is_block_stmt,
...
static void *block_stmt_constructor(void *_self, va_list *ap) {
...
static void *block_stmt_destructor(void *_self) {
	struct BlockStmt *self = _self;
	assert(IS_BLOCK_STMT(self));
...
static void *block_stmt_accept_visitor(const void *_self, const void *_ast_visitor) {
