...
static const struct AstNodeType _type_continue_stmt = {
	.size 					= sizeof(struct ContinueStmt),
	.constructor 			= continue_stmt_constructor,
	.destructor 			= continue_stmt_destructor,
	.accept_visitor 		= continue_stmt_accept_visitor,
	.is_ast_node 			= is_continue_stmt,
