...
static void *loop_stmt_constructor(void *self, va_list *ap);
static void *loop_stmt_destructor(void *self);

static void *loop_stmt_accept_visitor(const void *self, const void *ast_visitor);
static bool is_loop_stmt(const void *object);


static const struct AstNodeType _type_loop_stmt = {
	.size 					= sizeof(struct LoopStmt),
	.constructor 			= loop_stmt_constructor,
	.destructor 			= loop_stmt_destructor,
	.accept_visitor 		= loop_stmt_accept_visitor,
	.is_ast_node 			= is_loop_stmt,
...
static void *loop_stmt_constructor(void *_self, va_list *ap) {
...
static void *loop_stmt_destructor(void *_self) {
	struct LoopStmt *self = _self;
	assert(IS_LOOP_STMT(self));
...
static void *loop_stmt_accept_visitor(const void *_self, const void *_ast_visitor) {
