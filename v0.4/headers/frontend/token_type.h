	...
	// keywords
	extern const struct TokenType TOKEN_TYPE_IMPORT;
	...
	extern const struct TokenType TOKEN_TYPE_BITWISE_AND;
	extern const struct TokenType TOKEN_TYPE_BITWISE_OR;
	extern const struct TokenType TOKEN_TYPE_BITWISE_XOR;
	extern const struct TokenType TOKEN_TYPE_BITWISE_NOT;
