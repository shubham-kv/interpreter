	...
	struct AstVisitor {
		...
		void *(*visit_print_stmt)		(const void *ast_vititor, const void *print_stmt);
		...
		// void *(*visit_assign_expr)		(const void *ast_visitor, const void *assign_expr);
	...
	#define IS_AST_VISITOR(obj) ((obj) && (((struct AstVisitor *) obj)->type == AstVisitor))
