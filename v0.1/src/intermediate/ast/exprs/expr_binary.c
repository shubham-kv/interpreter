...
static const void *bexpr_get_lmost_token(const void *self);
static const void *bexpr_get_rmost_token(const void *self);
...
static const struct AstNodeType _type_binary_expr = {
	...
	is_binary_expr,
	bexpr_get_lmost_token,
	bexpr_get_rmost_token,
	NULL
};
...
static const void *bexpr_get_lmost_token(const void *_self) {
	const struct BinaryExpr *self = _self;
	assert(IS_BINARY_EXPR(self));
...
static const void *bexpr_get_rmost_token(const void *_self) {
	const struct BinaryExpr *self = _self;
	assert(IS_BINARY_EXPR(self));
