...
static const void *gexpr_get_lmost_token(const void *self);
static const void *gexpr_get_rmost_token(const void *self);
...
static const struct AstNodeType _type_get_expr = {
	...
	is_get_expr,
	gexpr_get_lmost_token,
	gexpr_get_rmost_token,
	NULL
};
...
static const void *gexpr_get_lmost_token(const void *_self) {
	const struct GetExpr *self = _self;
	assert(IS_GET_EXPR(self));
...
static const void *gexpr_get_rmost_token(const void *_self) {
	const struct GetExpr *self = _self;
	assert(IS_GET_EXPR(self));
