...
static const void *cexpr_get_lmost_token(const void *self);
static const void *cexpr_get_rmost_token(const void *self);


static const struct AstNodeType _type_call_expr = {
	sizeof(struct CallExpr),
	call_expr_constructor,
	call_expr_destructor,
	call_expr_accept_visitor,
	is_call_expr,
	cexpr_get_lmost_token,
	cexpr_get_rmost_token,
	NULL
};
...
static const void *cexpr_get_lmost_token(const void *_self) {
	const struct CallExpr *self = _self;
	assert(IS_CALL_EXPR(self));
...
static const void *cexpr_get_rmost_token(const void *_self) {
	const struct CallExpr *self = _self;
	assert(IS_CALL_EXPR(self));
