...
static const struct AstNodeType _type_id_assign_expr = {
	sizeof(struct IdentifierAssignExpr),
	id_assign_expr_constructor,
	id_assign_expr_destructor,
	id_assign_expr_accept_visitor,
	is_id_assign_expr,
	id_assign_expr_get_lmost_token,
	id_assign_expr_get_rmost_token,
	NULL
};
