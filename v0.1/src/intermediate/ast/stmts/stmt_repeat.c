...
static void *repeatstmt_constructor(void *self, va_list *ap);
static void *repeatstmt_destructor(void *self);

static void *repeatstmt_accept_visitor(const void *self, const void *ast_visitor);
static bool is_repeat_stmt(const void *object);


static const struct AstNodeType _type_repeat_stmt = {
	sizeof(struct RepeatStmt),
	repeatstmt_constructor,
	repeatstmt_destructor,
	repeatstmt_accept_visitor,
	is_repeat_stmt
};
...
static void *repeatstmt_constructor(void *_self, va_list *ap) {
...
static void *repeatstmt_destructor(void *_self) {
	struct RepeatStmt *self = _self;
	assert(IS_REPEAT_STMT(self));
...
static void *repeatstmt_accept_visitor(const void *_self, const void *_ast_visitor) {
